 ...
 *
 * Encourage development. If you use beauty_tips for anything cool
...
;(function($) { 
   ...
   * http://plugins.jquery.com/project/bgiframe - beauty_tips will automatically
   * recognize it and use it.
   *
   * beauty_tips also works with the hoverIntent plugin
